<template>
  <div>
    <div>
      <el-row>
        <el-col :span=4><div class="title">线下实验管理</div></el-col>
        <el-col :span=4><div class="add-box"><el-button type="primary" size="small" @click="add">添加实验</el-button></div></el-col>
    ...
    <div>
      <el-dialog :title= 'ti' :visible.sync="dialogFormVisible">
        <el-form :model="form">
          <el-form-item class="input-box" label="实验时间" :label-width="formLabelWidth">
            <el-date-picker
              style="width: auto"
              v-model="form.time"
              type="datetimerange"
          ...
          <el-form-item label="实验类别" :label-width="formLabelWidth" class="input-box select-box">
            <el-select v-model="form.style" placeholder="请选择实验类别">
              <el-option label="核磁" value="核磁"></el-option>
